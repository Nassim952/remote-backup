...
INSERT INTO bape_user (id, lastname, firstname, email, password, statut, allow, identity_id) VALUES
(1, 'DeSouza', 'Eyram', 'eyram@nearby.com', 'password', 1, 'admin', 1),
(2, 'Mbiya','Randy', 'randy@nearby.com','password', 1, 'admin', 2),
(3, 'Mmadi','Nassim','nassim@nearby.com','password', 1, 'admin', 3),
(4, 'Belatoui', 'Bilal','bilal@nearby.com','password', 1, 'admin', 4),
(5, 'Mondor', 'Andrew','andrew@nearby.com', 'password', 1, 'admin',5);
...
(2, 'Bad Boys For Life', '2022-01-02', '02:04', 'Si Mike Lowrey est un seducteur invetere, heritier dune fortune et policier par passion, son collegue et ami Marcus Burnett est un homme range, marie et pere de famille. Leur amitie ne les empêche pas davoir des methodes parfaitement differentes. Mais la disparition de cent kilos dheroine, derobes dans les locaux mêmes de la brigade des stups, va leur faire oublier leur concept sur la façon dexercer leur metier, pour se lancer a la poursuite des voleurs.'),
(3, 'Suicide Squad', '2020-01-02', '02:03', 'Cest tellement jouissif dêtre un salopard ! Face à une menace aussi enigmatique quinvincible, lagent secret Amanda Waller reunit une armada de crapules de la pire espece. Armes jusquaux dents par le gouvernement, ces Super-Mechants sembarquent alors pour une mission-suicide. Jusquau moment où ils comprennent quils ont ete sacrifies. Vont-ils accepter leur sort ou se rebeller ?'),
